...
<figcaption>Figure 2 - XY Plotter with example data. Bacteria have an exponential growth phase represented by the mathematical formula, n x 2^g. Thus, each bacterial cell is capable of generating 2 daughter cells asexually via binary fission.For more information on bacterial growth, see [Todar's: Growth of Bacterial Populations](http://textbookofbacteriology.net/growth_3.html)</figcaption>
