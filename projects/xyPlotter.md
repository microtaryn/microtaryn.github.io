...
With my webpage interface, a user can simply enter in ten XY pairs and click on "Make chart" to make a nice scatter plot. The user also has the option of labelling their data (See Figures 1 and 2).
...
<img width="500" src="../images/XYPlotter-2.png">
